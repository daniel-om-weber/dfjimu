...
def mekf_acc(gyr1, gyr2, acc1, acc2, r1, r2, Fs, q_init, Q_cov=None):
    ...
    Q_cov : (6,) diagonal covariance values for gyroscopes [var_gyr1, var_gyr2]. Optional.
            If None, estimated from first 50 samples.
    ...
    # Preprocessing: Acceleration at joint center
